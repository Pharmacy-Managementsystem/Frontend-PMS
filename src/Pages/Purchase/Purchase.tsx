...
export default function Purchase() {
  ...
  const renderActiveComponent = () => {
    switch(activeTab) {
      case 'Order Purchases': return <OrderPurchases />;
      case 'Receive Purchases': return <ReceivePurchases />;
      case 'Return Purchases': return <ReturnPurchases />;
      default: return <OrderPurchases />;
    }
  }
