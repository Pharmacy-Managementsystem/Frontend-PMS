    ...
    <section className="relative min-h-screen bg-gray-900 overflow-hidden flex items-center justify-center  p-6">
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto">
        ...
        <div className="relative mb-12">
          <h1 className="text-[120px] md:text-[180px] font-bold text-white tracking-tighter">
            <span className="relative">
              <span className="absolute inset-0 text-[#3B82F6] opacity-70 animate-glitch-1">
                404
              </span>
              <span className="absolute inset-0 text-[#2DD4BF] opacity-70 animate-glitch-2">
                404
              </span>
        ...
        <button
          ...
          className="relative px-8 py-4 bg-gradient-to-r from-[#3B82F6] to-[#2DD4BF] text-white font-bold rounded-lg overflow-hidden group"
        >
