...
const Products = () => {
  ...
  const tabs = [
    {
      id: 1,
      label: t("productsPage.tabs.productsList"),
      component: <ProductsList />,
    },
    {
      id: 2,
      label: t("productsPage.tabs.productsType"),
      component: <ProductsType />,
    },
    {
      id: 3,
      label: t("productsPage.tabs.productsUnit"),
      component: <ProductsUnit />,
    },
    {
      id: 4,
      label: t("productsPage.tabs.productsCompany"),
